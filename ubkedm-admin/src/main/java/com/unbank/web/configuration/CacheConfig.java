...
public class CacheConfig {
	...
	@Bean
	MessageListenerAdapter listenerAdapter(final MyRedisCacheManager cacheManager) {
	...
	class MyRedisCache extends RedisCache {
		...
		ConcurrentHashMap<Object, ValueWrapper> local = new ConcurrentHashMap<Object, ValueWrapper>();
