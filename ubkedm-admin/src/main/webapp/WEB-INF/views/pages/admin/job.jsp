					...
					任务管理 <small> <i class="ace-icon fa fa-angle-double-right"></i>
						...
						class="btn-toolbar inline middle no-margin"> <span
							data-toggle="buttons" class="btn-group no-margin"> <a
								href="#" class="btn btn-sm btn-yellow " id="nomal_job"> <i
									class="ace-icon fa fa-envelope "></i>进行中的任务
							</a> <a href="#" class="btn btn-sm btn-yellow " id="finish_job">
									<i class="ace-icon fa fa-envelope "></i>历史任务
							</a>
						</span>
					</span>
					</span>
